# ===================================================================
# Script de force application du fond d'ecran Xpolaris
...
Write-Log "============================================"
Write-Log "APPLICATION FOND D'ECRAN XPOLARIS"
Write-Log "============================================"
Write-Log ""

$WallpaperPath = "C:\Windows\Web\Wallpaper\XpolarisWallpaper.bmp"

# Verifier si le fond d'ecran existe
if (-not (Test-Path $WallpaperPath)) {
    Write-Log "[ERREUR] Fond d'ecran introuvable: $WallpaperPath"
    exit 1
}

Write-Log "[OK] Fond d'ecran trouve: $WallpaperPath"
Write-Log "[INFO] Taille: $([math]::Round((Get-Item $WallpaperPath).Length / 1MB, 2)) MB"
